...
if (!empty(config('settings.style.payment_icon_top_border_width'))) {
	...
	$cssBuffer .= '.payment-method-logo { border-top-width: ' . $paymentIconTopBorderSize . '; }';
...
if (!empty(config('settings.style.payment_icon_top_border_color'))) {
	$cssBuffer .= '.payment-method-logo { border-top-color: ' . config('settings.style.payment_icon_top_border_color') . '; }';
...
if (!empty(config('settings.style.payment_icon_bottom_border_width'))) {
	...
	$cssBuffer .= '.payment-method-logo { border-bottom-width: ' . $paymentIconBottomBorderSize . '; }';
}
if (!empty(config('settings.style.payment_icon_bottom_border_color'))) {
	$cssBuffer .= '.payment-method-logo { border-bottom-color: ' . config('settings.style.payment_icon_bottom_border_color') . '; }';
}
...
if (!empty(config('settings.style.btn_post_border_color_hover'))) {
	...
	$cssBuffer .= '#homepage a.btn-add-listing:hovehomepage .intro:not(.only-search-bar)r,';
	$cssBuffer .= '#homepage a.btn-add-listing:focus {';
...
if (isset($searchFormOptions['height']) and !empty($searchFormOptions['height'])) {
	...
	$cssBuffer .= '#homepage .intro:not(.only-search-bar) {';
...
if (isset($searchFormOptions['background_color']) and !empty($searchFormOptions['background_color'])) {
	$cssBuffer .= '#homepage .intro:not(.only-search-bar) { background: ' . $searchFormOptions['background_color'] . '; }';
}
$bgImgFound = false;
...
if (isset($searchFormOptions['big_title_color']) and !empty($searchFormOptions['big_title_color'])) {
	$cssBuffer .= '#homepage .intro:not(.only-search-bar) h1 { color: ' . $searchFormOptions['big_title_color'] . '; }';
}
if (isset($searchFormOptions['sub_title_color']) and !empty($searchFormOptions['sub_title_color'])) {
	$cssBuffer .= '#homepage .intro:not(.only-search-bar) p { color: ' . $searchFormOptions['sub_title_color'] . '; }';
}
if (isset($searchFormOptions['form_border_width']) and !empty($searchFormOptions['form_border_width'])) {
	...
	$cssBuffer .= '#homepage .search-row .search-col:first-child .search-col-inner,';
	$cssBuffer .= '#homepage .search-row .search-col .search-col-inner,';
	$cssBuffer .= '#homepage .search-row .search-col .search-btn-border {';
	$cssBuffer .= 'border-width: ' . $searchFormOptions['form_border_width'] . ';';
	$cssBuffer .= '}';
	
	$cssBuffer .= '@media (max-width: 767px) {' . "\n";
	$cssBuffer .= '.search-row .search-col:first-child .search-col-inner,' . "\n";
	$cssBuffer .= '.search-row .search-col .search-col-inner,' . "\n";
	$cssBuffer .= '.search-row .search-col .search-btn-border {' . "\n";
	$cssBuffer .= 'border-width: ' . $searchFormOptions['form_border_width'] . ';' . "\n";
	$cssBuffer .= '}' . "\n";
	$cssBuffer .= '}' . "\n";
}
if (isset($searchFormOptions['form_border_radius']) and !empty($searchFormOptions['form_border_radius'])) {
	...
	$cssBuffer .= getFormBorderRadiusCSS($formBorderRadius, $fieldsBorderRadius);
} else {
	$cssBuffer .= getFormBorderRadiusCSS(24, 24);
}
if (isset($searchFormOptions['form_border_color']) and !empty($searchFormOptions['form_border_color'])) {
	$cssBuffer .= '#homepage .search-row .search-col:first-child .search-col-inner,';
	$cssBuffer .= '#homepage .search-row .search-col .search-col-inner,';
	$cssBuffer .= '#homepage .search-row .search-col .search-btn-border {';
	$cssBuffer .= 'border-color: ' . $searchFormOptions['form_border_color'] . ';';
	$cssBuffer .= '}';
...
if (!empty(config('settings.style.page_width'))) {
	$pageWidth = strToDigit(config('settings.style.page_width')) . 'px';
	$cssBuffer .= '@media (min-width: 1200px) {';
	$cssBuffer .= '#homepage .intro.only-search-bar .container { max-width: ' . $pageWidth . '; }';
	$cssBuffer .= '}';
}
...
function getFormBorderRadiusCSS($formBorderRadius, $fieldsBorderRadius)
{
	...
	if (config('lang.direction') == 'rtl') {
		$cssBuffer .= '#homepage .search-row .search-col:first-child .search-col-inner {' . "\n";
		$cssBuffer .= 'border-top-right-radius: ' . $searchFormOptions['form_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= 'border-bottom-right-radius: ' . $searchFormOptions['form_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= '}' . "\n";
		$cssBuffer .= '#homepage .search-row .search-col:first-child .form-control {' . "\n";
		$cssBuffer .= 'border-top-right-radius: ' . $searchFormOptions['fields_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= 'border-bottom-right-radius: ' . $searchFormOptions['fields_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= '}' . "\n";
		$cssBuffer .= '#homepage .search-row .search-col .search-btn-border {' . "\n";
		$cssBuffer .= 'border-top-left-radius: ' . $searchFormOptions['form_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= 'border-bottom-left-radius: ' . $searchFormOptions['form_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= '}' . "\n";
		$cssBuffer .= '#homepage .search-row .search-col .btn {' . "\n";
		$cssBuffer .= 'border-top-left-radius: ' . $searchFormOptions['fields_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= 'border-bottom-left-radius: ' . $searchFormOptions['fields_border_radius'] . ' !important;' . "\n";
		$cssBuffer .= '}' . "\n";
	} else {
		$cssBuffer .= '#homepage .search-row .search-col:first-child .search-col-inner {' . "\n";
		$cssBuffer .= 'border-top-left-radius: ' . $searchFormOptions['form_border_radius'] . ' !important;' . "\n";
	...
	$cssBuffer .= '#homepage .search-row .search-col:first-child .form-control,' . "\n";
	$cssBuffer .= '#homepage .search-row .search-col:first-child .search-col-inner,' . "\n";
	$cssBuffer .= '#homepage .search-row .search-col .form-control,' . "\n";
	$cssBuffer .= '#homepage .search-row .search-col .search-col-inner,' . "\n";
	$cssBuffer .= '#homepage .search-row .search-col .btn,' . "\n";
	$cssBuffer .= '#homepage .search-row .search-col .search-btn-border {' . "\n";
	$cssBuffer .= 'border-radius: ' . $searchFormOptions['form_border_radius'] . ' !important;' . "\n";
	$cssBuffer .= '}' . "\n";
	$cssBuffer .= '}' . "\n";
