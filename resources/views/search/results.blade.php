...
@section('content')
	<div class="main-container">
		...
		@if (config('settings.listing.show_cats_in_top'))
		...
		<div class="container">
			<div class="row">
				...
				<div class="{{ $contentColSm }} page-content col-thin-left mb-4">
					<div class="category-list {{ config('settings.listing.display_mode', 'make-grid') }}{{ ($contentColSm == 'col-md-12') ? ' noSideBar' : '' }}">
						<div class="tab-box">
						...
						<div class="tab-box save-search-bar text-center">
							@if (request()->filled('q') && request()->get('q') != '' && $count->get('all') > 0)
								<a name="{!! qsUrl(request()->url(), request()->except(['_token', 'location']), null, false) !!}" id="saveSearch"
								   count="{{ $count->get('all') }}">
									<i class="far fa-star"></i> {{ t('Save Search') }}
								</a>
							@else
								<a href="#"> &nbsp; </a>
							@endif
		...
		<div class="container mb-3">
			<div class="card border-light text-dark bg-light mb-3">
				<div class="card-body text-center">
					...
					@if (!auth()->check() && config('settings.single.guests_can_post_ads') != '1')
