                    ...
                    <div class="col-lg-12">
                        <div class="course-wrapper">
                            <div class="course-item-01 text-center">
                                ...
                                <h4><a href="{{url('/coach_list_category_all/'.'1') }}">Al & Machine Learning</a></h4>
                            ...
                            <div class="course-item-01 text-center">
                                ...
                                <h4><a href="{{url('/coach_list_category_all/'.'1') }}">Data Analysis & Statistics</a></h4>
                                <input type="checkbox" style="width: 22px;">
                            </div>
                            <div class="course-item-01 text-center">
                                ...
                                <h4><a href="{{url('/coach_list_category_all/'.'1') }}">Business & Management</a></h4>
                                <!-- <input type="checkbox" style="width: 22px;"> -->
                            </div>
                            <div class="course-item-01 text-center">
                                ...
                                <h4><a href="{{url('/coach_list_category_all/'.'1') }}">Social Sciences</a></h4>
                                <!-- <input type="checkbox" style="width: 22px;"> -->
                            </div>
                            <div class="course-item-01 text-center">
                                ...
                                <h4><a href="{{url('/coach_list_category_all/'.'1') }}">Biology & Life Sciences</a></h4>
                                <!-- <input type="checkbox" style="width: 22px;"> -->
                            </div>
                        </div>
                    </div>
