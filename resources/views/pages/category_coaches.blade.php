        ...
        <div class=" col-lg-8 col-md-8 ">
            ...
            <div class="input-group">
                <div class="form-outline search-box-fix1">
                    <input type="text" id="form1" class="form-control search-box-for-main search-box-font"
                        placeholder=" Search for Coach, Industry, Location and more..." />

                </div>
                <button type="button"
                    class="btn btn87 btn-primary btn_class btn_class_coaches12 search-button-icon-width">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="teacher-item">
                ...
                <div class="teacher-meta">
                    ...
                    <a type="button" href="{{url('/coachall_detail/'.$coach_list->id) }}" data-toggle="modal"
                        data-target=".bd-example-modal-lg_{{$coach_list->id }}" id="coach_id_{{$coach_list->id }}">
                    ...
                    <div class="modal fade bd-example-modal-lg_{{$coach_list->id }}" tabindex="-1" role="dialog"
                        aria-labelledby="myLargeModalLabel" aria-hidden="true" id="coach_id_{{$coach_list->id }}">
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-content p-5">
                                ...
                                <img src="{{ url('storage/'.$coach_list->photo) }}" class="img-coches-main"
                                    alt="{{ $coach_list->name }}">
                                <p class="coach-details-name">{{$coach_list->name}}</p>
                                <h4 class=" text-center">
                                    Teaches Adventure Photography
                                ...
                                <label>{{$coach_list->name}} has built his career taking photos at the top of the world,
                                    earning him the cover of National Geographic and multiple awards. Now he’s taking
                                    you on location to teach you techniques for capturing
                                    breathtaking shots. In his photography class, learn different creative approaches
                                    for commercial shoots, editorial spreads, and passion projects. Gather the gear—and
                                    the perspective—to bring your
                                    photography to new heights.</label>
                                <br>
                                <div class="row center-button-modal">

                                    <div class="col-lg-2">
                                        <a href="{{url('/coachall_detail/'.$coach_list->id) }}" class="bisylms-btn"
                                            style="color: aliceblue!important;">Know more</a>
                                    </div>
                                    <div class="col-lg-2">
                                        <a href="{{url('/pricing') }}" class="bisylms-btn"
                                            style="color: aliceblue!important;">Get Started</a>
                                    </div>
                                </div>
                            </div>
                        </div>
