				...
				<div class="col-md-9 page-content ptop">
					<div class="inner-box">
						...
						@elseif ($pagePath=='archived')
							<h2 class="title-2"><i class="fas fa-calendar-times"></i> {{ t('archived_ads') }} </h2>
						@elseif ($pagePath=='favourite')
							<h2 class="title-2"><i class="far fa-heart"></i> {{ t('favourite_ads') }} </h2>
										...
										<td style="width:58%" class="items-details-td">
											<div>
												...
												<p>
													...
													<strong><i class="fas fa-map-marker-alt" title="{{ t('Located In') }}"></i></strong> {{ !empty($post->city) ? $post->city->name : '-' }}
