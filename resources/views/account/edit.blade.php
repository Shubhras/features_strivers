                                ...
                                <div class="card-header">
                                    <h4 class="card-title">
                                        <a href="#photoPanel" data-bs-toggle="collapse"
                                            data-parent="#accordion">{{ t('Photo or User') }}</a>
                                    </h4>
                                </div>
                                <?php
								$photoPanelClass = '';
                                ...
                                <div class="panel-collapse collapse {{ $photoPanelClass }}" id="photoPanel">
                                    <div class="card-body">
                                        <form name="details" class="form-horizontal" role="form" method="POST"
                                            action="{{ url('account/' . $user->id . '/photo') }}">
                                            <div class="row">
                                ...
                                <div class="panel-collapse collapse {{ $userPanelClass }}" id="userPanel">
                                    <div class="card-body">
                                        <form name="details" class="form-horizontal" role="form" method="POST"
                                            ...
                                            <div class="row mb-3 required">
                                                <label class="col-md-12" for="username">{{ ('Full Name') }}
                                                    <sup>*</sup></label>
                                                <div class="col-md-12">
                                            ...
                                            <div class="row mb-3 required">
                                                ...
                                                <div class="col-md-12">
                                                    <select name="country_code" id="location"
                                                        class="form-control large-data-selecter{{ $countryCodeError }}"
                                                        onclick="getlocation(this.value)">
											...
											foreach($all_countries as $top_coach_detail){
												...
												?>
                                                        ...
                                                        <option value="{{ $top_coach_detail->code }}"
                                                            {{ (old('country_code', $user->country_code)==$top_coach_detail->code) ? 'selected="selected"': '' }}>
                                                            {{ $ss['en'] }}
                                                        </option>
                                                        <?php  } ?>
                                                    </select>
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-text">
                                                            <input name="phone_hidden" id="phoneHidden" type="checkbox"
                                                                value="1"
                                                                {{ (old('phone_hidden', $user->phone_hidden)=='1') ? 'checked="checked"' : '' }}>&nbsp;
                                                            <small>{{ t('Hide') }}</small>
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mb-3 required">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <span class="input-group-text"><i
                                                                class="fas fa-experience"></i></span>
                                                        <input id="year_of_experience" name="year_of_experience"
                                                            type="text" class="form-control{{ $experienceError }}"
                                            ...
                                            <div class="row mb-3 required">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-check form-check-inline pt-2">
                                                        <input name="gender_id" id="gender_id-{{ $gender->id }}"
                                                            value="{{ $gender->id }}"
                                                            class="form-check-input{{ $genderIdError }}" type="radio"
                                                            {{ (old('gender_id', $user->gender_id)==$gender->id) ? 'checked="checked"' : '' }}>
                                            ...
                                            <div class="row mb-3 required">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea name="coach_summary"
                                                        class="form-control{{ $coach_summaryError }} new-form-control"
                                                        placeholder="Coach Summary"
                                                        rows="5">{{ old('coach_summary', $user->coach_summary) }}</textarea>
                                                </div>
                                            </div>
                                ...
                                <div class="panel-collapse collapse {{ $settingsPanelClass }}" id="settingsPanel">
                                    <div class="card-body">
                                        <form name="settings" class="form-horizontal" role="form" method="POST"
                                            ...
                                            @if (config('settings.single.activation_facebook_comments') &&
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-check pt-2">
                                                        <input id="disable_comments" name="disable_comments"
...
var photoInfo = '<h6 class="text-muted pb-0">{{ t('
Click to select ') }}</h6>';
...
$('#photoField').fileinput({
    ...
    minFileSize: {
        {
            (int) config('settings.upload.min_image_size', 0)
        }
    },
    {
        {
    ...
    maxFileSize: {
        {
            (int) config('settings.upload.max_image_size', 1000)
        }
    },
    {
        {
    ...
    defaultPreviewContent: '<img src="{{ url('
    images / user.jpg ') }}" alt="{{ t('
    Your Photo or Avatar ') }}">' + photoInfo,
...
$('#photoField').on('filebatchuploadsuccess', function(event, data, previewId, index) {
    ...
    $.each(data.files, function(key, file) {
        if (typeof file !== 'undefined') {
            var fname = file.name;
            out = out + {
                !!t('Uploaded file X successfully') !!
            };
        }
    });
