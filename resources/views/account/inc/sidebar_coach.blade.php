		...
		<div class="navbar-nav flex-column w-100 ">
			...
			<div class="py-4 p-md-4 ">
				...
				<ul class="list-unstyled mb-4 mt-2">
					...
					<li class="nav-item" id="MyClassified">
					<a {!! ($pagePath=='' ) ? 'class="active"' : '' !!} href="{{ url('my_striver') }}">{{ ('My Strivers') }}</a>
					</li>
					<li class="nav-item " id="MyClassified">
					<a {!! ($pagePath=='' ) ? 'class="active"' : '' !!} href="{{ url('my_courses') }}">Consultation</a>
					</li>
					<li class="nav-item " id="MyClassified">
					<a {!! ($pagePath=='' ) ? 'class="active"' : '' !!} href="{{ url('my_payments') }}">{{ ('My payments') }}</a>
					</li>
