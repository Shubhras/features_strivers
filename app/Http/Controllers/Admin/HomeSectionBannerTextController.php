...
class HomeSectionBannerTextController extends PanelController
{
    public function setup()
	{
		...
		*/
        ...
        $this->xPanel->addField([
			'name'       => 'home_page_section_two_banner_image',
			'label'      => trans('Home Banner Two Image'),
			'type'   => 'image',
			'upload' => true,
			'disk'   => 'public',
		]);
        ...
        $this->xPanel->addField([
			'name'       => 'home_page_section_three_banner_image',
			'label'      => trans('home page three banner image'),
			'type'   => 'image',
			'upload' => true,
			'disk'   => 'public',
		]);
