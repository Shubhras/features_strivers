...
class HomeSectionBannerText extends BaseUser
{
	...
	protected $fillable = [
		...
		'home_page_section_two_banner_image',
		'home_page_section_banner_text_top_heading',
		'home_page_section_banner_tex_heading',
		'home_page_section_banner_text_two',
		'home_page_section_three_banner_image',
		'home_page_section_banner_text_three_heading',
		'home_page_section_banner_text_three',
		
	];
	public $translatable = ['picture', 'home_page_section_banner_text','home_page_section_two_banner_image', 'home_page_section_banner_text_top_heading', 'home_page_section_banner_tex_heading', 'home_page_section_banner_text_two','home_page_section_three_banner_image','home_page_section_banner_text_three_heading','home_page_section_banner_text_three'];
