...
class LetestNews extends BaseModel
{
	...
	*/
	protected static function boot()
	{
		...
		LetestNews::observe(PageObserver::class);
	...
	public function getNameHtml()
	{
        ...
        // return '<a href="' . UrlGen::latest_news($this) . '" target="_blank">' . $this->name . '</a>';
		return '<a href="' . UrlGen::letest_news($this) . '" target="_blank">' . $this->name . '</a>';
	}
	...
	*/
	...
	{
		return $this->belongsTo(LetestNews::class, 'parent_id');
	}
