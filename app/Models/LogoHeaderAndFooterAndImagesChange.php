...
class LogoHeaderAndFooterAndImagesChange extends BaseUser
{
	...
	protected $fillable = [
		...
		'index_section_2',
		'index_section_3_image',
		'index_section_4_text',
		'index_section_5_image',
		// 'index_section_6_text',
		// 'index_section_7_text',
		// 'about_section_1_text',
		// 'about_section_2_video',
		// 'about_section_3_text',
		// 'pricing_section_1_text',
		// 'pricing_section_2_text',
		// 'pricing_section_3_text',
		// 'pricing_section_4_text',
		// 'pricing_section_5_text',
	];
	
	public $translatable = ['index_header_logo_1', 'index_header_logo_2', 'index_footer_logo_1', 'index_footer_logo_2', 'index_section_1_text', 'index_section_2','index_section_1_text','index_section_2','index_section_3_image','index_section_4_text','index_section_5_image','index_section_6_text','index_section_7_text','about_section_1_text','about_section_2_video','about_section_3_text','pricing_section_1_text','pricing_section_2_text','pricing_section_3_text','pricing_section_4_text','pricing_section_5_text'];
	...
	*/
	protected static function boot()
	{
		...
		LogoHeaderAndFooterAndImagesChange::observe(UserObserver::class);
	...
	*/
	...
	{
		$disk = StorageDisk::getDisk();
		$attribute_name = 'index_header_logo_1';
