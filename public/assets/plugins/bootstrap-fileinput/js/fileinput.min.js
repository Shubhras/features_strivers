...
! function(e) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], e) : "object" == typeof module && module.exports ? module.exports = e(require("jquery")) : e(window.jQuery) }(function(e) {
    ...
    t = {
        ...
        getFileId: function(e, i) { var a = t.getFileRelativePath(e); return "function" == typeof i ? i(e) : e && a ? e.size + "_" + encodeURIComponent(a).replace(/%/g, "_") : null },
        getFrameSelector: function(e, t) { return t = t || "", '[id="' + e + '"]' + t },
        getZoomSelector: function(e, i) { return t.getFrameSelector("zoom-" + e, i) },
            ...
            stash: function(i) {
                ...
                n.find("[style]").each(function(i, r) {
                    var n = e(r),
                        ...
                        l = t.uniqId(),
                        s = {};
                    o && o.length && (e(o).each(function() { s[this] = o[this] }), a.domElementsStyles[l] = s, n.removeAttr("style").attr(a.CSP_ATTRIB, l))
        ...
        closeButton: function(e) { return e = (t.isBs(5) ? "btn-close" : "close") + (e ? " " + e : ""), '<button type="button" class="' + e + '" aria-label="Close">\n' + (t.isBs(5) ? "" : '  <span aria-hidden="true">&times;</span>\n') + "</button>" },
                ...
                a = i.taskManager = {
                    ...
                    TasksPool: function(i) {
                        ...
                        r.id = i, r.cancelled = !1, r.cancelledDeferrer = e.Deferred(), r.tasks = {}, r.addTask = function(e, t) { return r.tasks[e] = new a.Task(e, t) }, r.size = function() { return t.getObjectSize(r.tasks) }, r.run = function(i) {
                            ...
                            for (n = function(t) { e.when(t.deferred).fail(function() { s = !0, o.apply(null, arguments) }).always(o) }, o = function() { var e = t.getArray(arguments); return u.notify(e), c.push(e), r.cancelled ? (u.reject.apply(null, c), void r.cancelledDeferrer.resolve()) : (c.length === r.size() && (s ? u.reject.apply(null, c) : u.resolve.apply(null, c)), void(d.length && (a = d.shift(), n(a), a.run()))) }; d.length && l++ < i;) a = d.shift(), n(a), a.run();
                            return u
            ...
            i.uploadStartTime = t.now(), i.fileManager = {
                ...
                getUploadStats: function(e, a, r) {
                    ...
                    return setTimeout(function() {
                        var e, t, i, a = 0,
                            r = 0;
                        for (o.bpsLog.push(c), o.bpsLog.sort(function(e, t) { return e - t }), t = o.bpsLog.length, i = t > 10 ? t - 10 : Math.ceil(t / 2), e = t; e > i; e--) r = parseFloat(o.bpsLog[e]), a++;
                        o.bps = 64 * (a > 0 ? r / a : 0)
                    }, p), n = { fileId: e, started: l, elapsed: s, loaded: a, total: r, bps: o.bps, bitrate: i._getSize(o.bps, d), pendingBytes: u }, e ? o.stats[e] = n : o.stats = n, n
                },
                ...
                list: function() { var t = []; return e.each(i.getFileStack(), function(e, i) { i && i.file && t.push(i.file) }), t },
                isPending: function(t) { return -1 === e.inArray(t, i.fileManager.filesProcessed) && i.fileManager.exists(t) },
                isProcessed: function() {
                    var t = !0,
                        a = i.fileManager;
                    return e.each(i.getFileStack(), function(e) { a.isPending(e) && (t = !1) }), t
                },
                clear: function() {
                    var e = i.fileManager;
                ...
                getThumbIndex: function(e) { var t = i._getThumbFileId(e); return i.fileManager.getIndex(t) },
        ...
        _initResumableUpload: function() {
            ...
            if (a.enableResumableUpload) {
                if (r.fallback !== !1 && "function" != typeof r.fallback && (r.fallback = function(e) { e._log(n.noResumableSupport), e.enableResumableUpload = !1 }), !t.hasResumableUploadSupport() && r.fallback !== !1) return void r.fallback(a);
                ...
                i = a.resumableManager = {
                    init: function(e, t, n) { i.logs = [], i.stack = [], i.error = "", i.id = e, i.file = t.file, i.fileName = t.name, i.fileIndex = n, i.completed = !1, i.lastProgress = 0, a.showPreview && (i.$thumb = o.getThumb(e) || null, i.$progress = i.$btnDelete = null, i.$thumb && i.$thumb.length && (i.$progress = i.$thumb.find(".file-thumb-progress"), i.$btnDelete = i.$thumb.find(".kv-file-remove"))), i.chunkSize = 1024 * r.chunkSize, i.chunkCount = i.getTotalChunks() },
                    setAjaxError: function(e, t, o, l) { e.responseJSON && e.responseJSON.error && (o = e.responseJSON.error.toString()), l || (i.error = o), r.showErrorLog && a._log(n.ajaxError, { status: e.status, error: o, text: e.responseText || "" }) },
                    reset: function() { i.stack = [], i.chunksProcessed = {} },
                    ...
                    getUploadedSize: function() { var e = i.processedResumables() * i.chunkSize; return e > i.file.size ? i.file.size : e },
                    getTotalChunks: function() { var e = parseFloat(i.chunkSize); return !isNaN(e) && e > 0 ? Math.ceil(i.file.size / e) : 0 },
                    getProgress: function() {
                        var e = i.processedResumables(),
                            t = i.chunkCount;
                        return 0 === t ? 0 : Math.ceil(e / t * 100)
                    },
                    checkAborted: function(e) { a._isAborted() && (clearInterval(e), a.unlock()) },
                    upload: function() {
                        var e, r = o.getIdList(),
                            n = "new";
                    ...
                    uploadResumable: function() {
                        var e, t, n = a.taskManager,
                            o = i.chunkCount;
                        for (t = n.addPool(i.id), e = 0; o > e; e++) i.logs[e] = !(!i.chunksProcessed[i.id] || !i.chunksProcessed[i.id][e]), i.logs[e] || i.pushAjax(e, 0);
                        t.run(r.maxThreads).done(function() { i.setProcessed("success") }).fail(function() { i.setProcessed(t.cancelled ? "cancel" : "error") })
                    },
                    processUpload: function() {
                        var n, l, s, d, c, u, p, f = i.id;
                        return r.testUrl ? (n = new FormData, l = o.stack[f], a._setUploadData(n, { fileId: f, fileName: l.fileName, fileSize: l.size, fileRelativePath: l.relativePath, chunkSize: i.chunkSize, chunkCount: i.chunkCount }), s = function(e) { p = a._getOutData(n, e), a._raise("filetestbeforesend", [f, o, i, p]) }, d = function(r, l, s) {
                            p = a._getOutData(n, s, r);
                            var d = a.uploadParamNames,
                                c = d.chunksUploaded || "chunksUploaded",
                                u = [f, o, i, p];
                            r[c] && t.isArray(r[c]) ? (i.chunksProcessed[f] || (i.chunksProcessed[f] = {}), e.each(r[c], function(e, t) { i.logs[t] = !0, i.chunksProcessed[f][t] = !0 }), i.chunksProcessed[f].data = r, a._raise("filetestsuccess", u)) : a._raise("filetesterror", u), i.uploadResumable()
                        }, c = function(e, t, r) { p = a._getOutData(n, e), a._raise("filetestajaxerror", [f, o, i, p]), i.setAjaxError(e, t, r, !0), i.uploadResumable() }, u = function() { a._raise("filetestcomplete", [f, o, i, a._getOutData(n)]) }, void a._ajaxSubmit(s, d, u, c, n, f, i.fileIndex, r.testUrl)) : void i.uploadResumable()
                    },
                    ...
                    sendAjax: function(e, l, s) {
                        var d, c = i.chunkSize,
                            ...
                            g = t.logMessages,
                            m = i.$btnDelete,
                            h = function(e, t) { t && (e = e.setTokens(t)), e = g.resumableRequestError.setTokens({ msg: e }), a._log(e), s.reject(e) };
                        if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
                            ...
                            var v, w, b, _, C, y, x = p.slice ? "slice" : p.mozSlice ? "mozSlice" : p.webkitSlice ? "webkitSlice" : "slice",
                                T = p[x](c * e, c * (e + 1));
                            v = new FormData, d = o.stack[u], a._setUploadData(v, { chunkCount: i.chunkCount, chunkIndex: e, chunkSize: c, chunkSizeStart: c * e, fileBlob: [T, i.fileName], fileId: u, fileName: i.fileName, fileRelativePath: d.relativePath, fileSize: p.size, retryCount: l }), i.$progress && i.$progress.length && i.$progress.show(), b = function(r) { w = a._getOutData(v, r), a.showPreview && (f.hasClass("file-preview-success") || (a._setThumbStatus(f, "Loading"), t.addCss(f, "file-uploading")), m.attr("disabled", !0)), a._raise("filechunkbeforesend", [u, e, l, o, i, w]) }, _ = function(t, d, c) {
                                ...
                                var p = a.uploadParamNames,
                                    ...
                                    m = [u, e, l, o, i, w];
                                t.error ? (r.showErrorLog && a._log(n.retryStatus, { retry: l + 1, filename: i.fileName, chunk: e }), a._raise("filechunkerror", m), i.pushAjax(e, l + 1), i.error = t.error, h(t.error)) : (i.logs[t[f]] = !0, i.chunksProcessed[u] || (i.chunksProcessed[u] = {}), i.chunksProcessed[u][t[f]] = !0, i.chunksProcessed[u].data = t, s.resolve.call(null, t), a._raise("filechunksuccess", m), i.check())
                            }, C = function(t, r, n) { return a._isAborted() ? void h(g.resumableAborting) : (w = a._getOutData(v, t), i.setAjaxError(t, r, n), a._raise("filechunkajaxerror", [u, e, l, o, i, w]), i.pushAjax(e, l + 1), void h(g.resumableRetryError, { n: l - 1 })) }, y = function() { a._isAborted() || a._raise("filechunkcomplete", [u, e, l, o, i, a._getOutData(v)]) }, a._ajaxSubmit(b, _, y, C, v, u, i.fileIndex)
                        }
                    }
                }, i.reset()
            }
        ...
        _listen: function() {
            var i, a = this,
                ...
                n = a.$form,
                o = a.$container;
            a._handler(r, "click", function(e) { r.hasClass("file-no-browse") && (r.data("zoneClicked") ? r.data("zoneClicked", !1) : e.preventDefault()) }), a._handler(r, "change", e.proxy(a._change, a)), a.showBrowse && (a._handler(a.$btnFile, "click", e.proxy(a._browse, a)), a._handler(a.$btnFile, "keypress", function(e) {
        ...
        _zoneDragEnter: function(i) {
            ...
            return a._zoneDragDropInit(i), a.isDisabled || !n ? (r.effectAllowed = "none", void(r.dropEffect = "none")) : (r.dropEffect = "copy", void(a._raise("fileDragEnter", { sourceEvent: i, files: r.types.Files }) && t.addCss(a.$dropZone, "file-highlighted")))
        },
        ...
        _getZoomButton: function(e) {
            var i = this,
                ...
                o = t.isBs(5) ? "bs-" : "",
                l = n + ("close" === e ? " data-" + o + 'dismiss="modal" aria-hidden="true"' : "");
            return "fullscreen" !== e && "borderless" !== e && "toggleheader" !== e || (l += ' data-toggle="button" aria-pressed="false" autocomplete="off"'), '<button type="button" class="' + r + " btn-kv-" + e + '"' + l + ">" + a + "</button>"
        },
            ...
            i.showPreview && setTimeout(function() {
                i._getThumbs(t.FRAMES + ".file-preview-success").each(function() {
                    ...
                    r.removeAttr("disabled"), i._handler(r, "click", function() {
                        ...
                        t.cleanMemory(a), r !== !1 && (i.$caption.attr("title", ""), a.fadeOut("slow", function() { a.remove(), i.getFrames().length || i.reset() }))
                    })
                })
            }, i.processDelay)
        },
        ...
        _uploadSingle: function(i, a, r) {
            ...
            w.enableResumableUpload || (w.showPreview && (o = b.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(F) || (v = function() { c ? b.errors.push(a) : b.removeFile(a), b.setProcessed(a), b.isProcessed() && (w.fileBatchCompleted = !0, l()) }, l = function() {
                var e;
        ...
        _generatePreviewTemplate: function(i, a, r, n, o, l, s, d, c, u, p, f, g, m) {
            var h, v, w, b = this,
                ...
                S = E ? "other" : i;
            return v = 400 > x ? b.previewSettingsSmall[S] || b.defaults.previewSettingsSmall[S] : b.previewSettings[S] || b.defaults.previewSettings[S], v && e.each(v, function(e, t) { y += e + ":" + t + ";" }), w = function(a, s, d, u) {
                var m = d ? "zoom-" + o : o,
        ...
        _setFileUploadStats: function(i, a, r) {
            ...
            if (n.showPreview || o && o.length) {
                ...
                } else s.setProgress(i, a), o = c && c.length ? c.find(".file-thumb-progress") : null, n._setProgress(a, o, null, n._getStats(r)), e.each(s.stats, function(e, t) { u += t.loaded }), f.pendingBytes = p - u, l = t.round(u / p * 100), n._setProgress(l, null, null, n._getStats(f))
            }
        },
        ...
        _getResizedImage: function(i, a, r, n) {
            var o, l, s, d, c, u, p, f, g, m, h = this,
                ...
                I = a.thumb,
                S = a.exifObj;
            if (c = function(e, t, i) { h.isAjaxUpload ? h._showFileError(e, t, i) : h._showError(e, t, i), h._setPreviewError(I) }, f = h.fileManager.getFile(i), g = { id: k, index: E, fileId: i }, m = [i, k, E], (!f || !x || C >= w && y >= b) && (x && f && h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized"), !x)) return void c(h.msgImageResizeError, g, "fileimageresizeerror");
            ...
            try { P.drawImage(v, 0, 0, w, b), d = T.toDataURL(F, h.resizeQuality), S && (p = window.piexif.dump(S), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), h.fileManager.setFile(i, o), h._raise("fileimageresized", m), r.val++, r.val === n && h._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(h.msgImageResizeError, g, "fileimageresizeerror") } catch (A) { r.val++, r.val === n && h._raise("fileimagesresized", [void 0, void 0]), u = h.msgImageResizeException.replace("{errors}", A.message), c(u, g, "fileimageresizeexception") }
        },
        ...
        _renderMain: function() {
            ...
            return n = e._setTabIndex("caption", n), e.mainTemplate.setTokens({ "class": e.mainClass + (!e.showBrowse && e.showCaption ? " no-browse" : ""), preview: a, close: i, caption: n, upload: e._renderButton("upload"), remove: e._renderButton("remove"), cancel: e._renderButton("cancel"), pause: e._renderButton("pause"), browse: e._renderButton("browse") })
        },
        _renderButton: function(e) {
            ...
            return a = i._setTabIndex(e, a), r += "browse" === e ? " btn-file" : " fileinput-" + e + " fileinput-" + e + "-button", t.isEmpty(l) || (l = ' <span class="' + i.buttonLabelClass + '">' + l + "</span>"), a.setTokens({ type: d, css: r, title: n, status: s, icon: o, label: l })
        },
        ...
        readFiles: function(i) {
            ...
            r.fileManager.clearImages(), e.each(i, function(e, t) {
                ...
                r.lock(!0);
                var y, x, T, P, F, k, E, I, S, A, D, z, j = i[w],
                    U = r._getFileId(j),
                    M = c + "-" + U,
                    $ = p.image,
                    R = r._getFileName(j, ""),
                    ...
                    W = 0,
                    V = function() {
                        var e = !!C.loadedImages[U],
                            t = d.setTokens({ index: w + 1, files: u, percent: 50, name: R });
                        setTimeout(function() { l.html(t), r._updateFileDetails(u), a(w + 1) }, r.processDelay), r._raise("fileloaded", [j, M, U, w, n]) && r.isAjaxUpload ? e || C.add(j) : e && C.removeFile(U)
                    };
                if (j) {
                    if (I = C.getId(j), g > 0)
                        for (x = 0; g > x; x++) k = f[x], E = r.msgFileTypes[k] || k, Z += 0 === x ? E : ", " + E;
                    if (R === !1) return void a(w + 1);
                    if (0 === R.length) return T = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(j), "[unknown]")), void v(T, j, M, w, I);
                    if (t.isEmpty(m) || (O = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = B.toFixed(2), r.isAjaxUpload && C.exists(I) || r._getFrame(M, !0).length) { var q = { id: M, index: w, fileId: I, file: j, files: i }; return T = r.msgDuplicateFile.setTokens({ name: R, size: y }), void(r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [j, I, R, y, M, w]), a(w + 1), r._updateFileDetails(u)) : (r._showError(T, q), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u))) }
                    if (r.maxFileSize > 0 && B > r.maxFileSize) return T = r.msgSizeTooLarge.setTokens({ name: R, size: y, maxSize: r.maxFileSize }), void v(T, j, M, w, I);
                    if (null !== r.minFileSize && B <= t.getNum(r.minFileSize)) return T = r.msgSizeTooSmall.setTokens({ name: R, size: y, minSize: r.minFileSize }), void v(T, j, M, w, I);
                    if (!t.isEmpty(f) && t.isArray(f)) { for (x = 0; x < f.length; x += 1) P = f[x], A = p[P], N += A && "function" == typeof A && A(j.type, t.getFileName(j)) ? 1 : 0; if (0 === N) return T = r.msgInvalidFileType.setTokens({ name: R, types: Z }), void v(T, j, M, w, I) }
                    if (0 === N && !t.isEmpty(m) && t.isArray(m) && !t.isEmpty(O) && (F = t.compare(R, O), N += t.isEmpty(F) ? 0 : F.length, 0 === N)) return T = r.msgInvalidFileExtension.setTokens({ name: R, extensions: h }), void v(T, j, M, w, I);
                    if (!r._canPreview(j)) return S = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n]), r.isAjaxUpload && S && C.add(j), r.showPreview && S && (o.addClass("file-thumb-loading"), r._previewDefault(j), r._initFileActions()), void setTimeout(function() { S && r._updateFileDetails(u), a(w + 1), r._raise("fileloaded", [j, M, U, w]) }, 10);
                    D = $(j.type, R), l.html(s.replace("{index}", w + 1).replace("{files}", u)), o.addClass("file-thumb-loading"), n.onerror = function(e) { r._errorHandler(e, R) }, n.onload = function(i) {
                        var a, s, d, c, u, f, g = [],
                            m = function() {
                                var e = new FileReader;
                                e.onerror = function(e) { r._errorHandler(e, R) }, e.onload = function(e) { return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n]) ? (H = !0, r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable()) : (r._previewFile(w, j, e, L, s), r._initFileActions(), void V()) }, e.readAsDataURL(j)
                            };
                        if (s = { name: R, type: j.type }, e.each(p, function(e, t) { "object" !== e && "other" !== e && "function" == typeof t && t(j.type, R) && W++ }), 0 === W) { for (d = new Uint8Array(i.target.result), x = 0; x < d.length; x++) c = d[x].toString(16), g.push(c); if (a = g.join("").toLowerCase().substring(0, 8), f = t.getMimeType(a, "", ""), t.isEmpty(f) && (u = t.arrayBuffer2String(n.result), f = t.isSvg(u) ? "image/svg+xml" : t.getMimeType(a, u, j.type)), s = { name: R, type: f }, D = $(f, "")) return void m(z) }
                        return r.isAjaxUpload && !r._raise("filebeforeload", [j, w, n]) ? (H = !0, r._resetCaption(), n.abort(), l.html(""), o.removeClass("file-thumb-loading"), void r.enable()) : (r._previewFile(w, j, i, L, s), r._initFileActions(), void V())
                    }, n.onprogress = function(e) {
                        if (e.lengthComputable) {
                            var t = e.loaded / e.total * 100,
                                i = Math.ceil(t);
                            T = d.setTokens({ index: w + 1, files: u, percent: i, name: R }), setTimeout(function() { H || l.html(T) }, r.processDelay)
                        }
        ...
        resume: function() {
            ...
            return t.bpsLog = [], t.bps = 0, e.enableResumableUpload ? (e.paused ? e._toggleResumableProgress(e.progressPauseTemplate, e.msgUploadResume) : i = !0, e.paused = !1, i && e._toggleResumableProgress(e.progressInfoTemplate, e.msgUploadBegin), setTimeout(function() { a.upload() }, e.processDelay), e.$element) : e.$element
        },
        pause: function() {
            var t, i = this,
            ...
            return i.showPreview && i._getThumbs().each(function() {
                ...
                a.removeClass("file-uploading"), n.attr("title") === l.indicatorLoadingTitle && (i._setThumbStatus(a, "Paused"), t = r.setTokens({ pendingTime: i.msgPaused, uploadSpeed: "" }), i.paused = !0, i._setProgress(o, a.find(".file-thumb-progress"), o + "%", t)), i._getThumbFile(a) || a.find(".kv-file-remove").removeClass("disabled").removeAttr("disabled")
        ...
        upload: function() {
            ...
            }), r.$preview.find(".file-preview-initial").removeClass(t.SORT_CSS), r._initSortable()), r._setProgress(2), r.hasInitData = !1, r.uploadAsync ? (i = 0, void e.each(r.getFileStack(), function(e) { r._uploadSingle(i, e, !0), i++ })) : (r._uploadBatch(), r.$element))) : void r._showFileError(r.msgUploadEmpty)) : void 0
        },
        destroy: function() {
            var t = this,
                i = t.$form,
    ...
    e.fn.fileinput.defaults = {
        ...
        deleteExtraData: {},
        overwriteInitial: !0,
        sanitizeZoomCache: function(e) { var i = t.createElement(e); return i.find("input,textarea,select,datalist,form,.file-thumbnail-footer").remove(), i.html() },
        ...
        previewZoomButtonClasses: { prev: "btn btn-navigate", next: "btn btn-navigate", toggleheader: r, fullscreen: r, borderless: r, close: r },
        previewTemplates: {},
        ...
        resumableUploadOptions: { fallback: null, testUrl: null, chunkSize: 2048, maxThreads: 4, maxRetries: 3, showErrorLog: !0, retainErrorHistory: !0, skipErrorsAndProceed: !1 },
        uploadExtraData: {},
        zoomModalHeight: 480,
        minImageWidth: null,
        minImageHeight: null,
        ...
        tabIndexConfig: { caption: 500, browse: 500, remove: 500, upload: 500, cancel: null, pause: null, modal: -1 }
